...
function FacebookRegMobile() {
    ...
    const handleRegistration = async () => {
        ...
        try {
            const registerResponse = await fetch('https://localhost:8800/server/auth/register', {
                method: 'POST',
            ...
            >
                {showBuyerSeller && (
                    <>
                            ...
                            <div className={`SellerSelection`}
                                ...
                                <div className="SellerTypos"
                                    ...
                                    <Typography
                                        ...
                                        {t('The one who builds projects for someone else.')}
                                    </Typography>
                                </div>
                            </div>
                        )}
                        ...
                        <div className="BackToLogin slide-from-right"
                ...
                {showUserinterest && (
                    <>
                        ...
                        <div className="UserIntereset slide-from-right"
                            style={{
                                width: currentLanguage === 'ar' ? '102%' : '84%',
                                height: '200px',
                                marginTop: '10px',
                                marginLeft: '-5px',
