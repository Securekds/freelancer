            ...
            {isScreenUnder450px ? (
                    ...
                    <div className="button-container">
                        ...
                        <div className="Underline "
                            style={{
                                ...
                                marginLeft: '12px',
                                position: 'relative',
                                right: currentLanguage === 'ar' ? '25px' : 'undefinid',
                                background: 'linear-gradient(to right, #5B42F3, #00DDEB)',
                            }}
                        />
                    </div>
                ...
                <div className=''
                    style={{
                        ...
                        position: 'relative',
                        left: '5px',
                        right: currentLanguage === 'ar' ? '250px' : 'undifined',
                    ...
                    <div className="div">
                        ...
                        <div className="Underline"
                            style={{
                                ...
                                height: '3px',
                                marginTop: '3px',
                                marginRight: currentLanguage === 'ar' ? '33px' : 'undifined',
                                marginLeft: '8px',
                                background: 'linear-gradient(to right, #5B42F3, #00DDEB)',
                ...
                <div className=''
                    style={{
                        ...
                        position: 'relative',
                        left: '10px',
                        right: currentLanguage === 'ar' ? '310px' : 'undifined',
