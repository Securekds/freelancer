...
function CardEdit({ onAddCardClick1, onLogoClick, logoPath , onCloseClick }) {
    ...
    return (
        ...
        >
            ...
            <Tabs TABS={TABS} onCloseClick={onCloseClick} selected={selected} setSelected={setSelected} onAddCardClick1={onAddCardClick1} />
...
const Tabs = ({ TABS, selected, setSelected, logoPath, onAddCardClick1, onLogoClick , onCloseClick }) => {
    ...
    return (
        ...
        >
            ...
            <AnimatePresence>
                {selected && <Content onCloseClick={onCloseClick}  logoPath={logoPath} onLogoClick={onLogoClick} dir={dir} selected={selected} TABS={TABS} onAddCardClick1={onAddCardClick1} />}
            </AnimatePresence>
        </div>
    );
};
...
const Content = ({ selected, dir, TABS, onAddCardClick1, onLogoClick, logoPath  ,onCloseClick }) => {
                    ...
                    return (
                        <div style={{}} key={t.id}>
                            {selected === t.id && (
                                ...
                                >
                                    <t.Component onCloseClick={onCloseClick} logoPath={logoPath} onLogoClick={onLogoClick} onAddCardClick1={onAddCardClick1} />
...
const Pricing = ({ handleDrawerClose, onAddCardClick1, onLogoClick, onCloseClick }) => {
        ...
        >
            ...
            <div className="DahabiyaCard"
                style={{
                    ...
                    backgroundImage: 'url("data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22100%25%22 height=%22100%25%22 viewBox=%220 0 1600 800%22%3E%3Cg%3E%3Cpolygon fill=%22%230d1838%22 points=%221600%2C160 0%2C460 0%2C350 1600%2C50%22/%3E%3Cpolygon fill=%22%230e315d%22 points=%221600%2C260 0%2C560 0%2C450 1600%2C150%22/%3E%3Cpolygon fill=%22%230f4981%22 points=%221600%2C360 0%2C660 0%2C550 1600%2C250%22/%3E%3Cpolygon fill=%22%231062a6%22 points=%221600%2C460 0%2C760 0%2C650 1600%2C350%22/%3E%3Cpolygon fill=%22%23117aca%22 points=%221600%2C800 0%2C800 0%2C750 1600%2C450%22/%3E%3C/g%3E%3C/svg%3E")',
            ...
            >
                <div class="form-input" style={{ width: '100%' }}>
                    ...
                    <label
                        ...
                        style={{
                            fontFamily: currentLanguage === 'ar' ? '"Droid Arabic Kufi", serif' : '"Airbnbcereal", sans-serif',
                            width: isSmallScreen && currentLanguage === 'fr'? '35%' :
                            currentLanguage === 'fr'? '17%' :
                              currentLanguage === 'ar' ? '14%' :
                                isSmallScreen ? '27%' :
                                    '15%',
                ...
                <div class="form-input" style={{ width: '100%' }}>
                    ...
                    <label
                        ...
                        style={{
                            fontFamily: currentLanguage === 'ar' ? '"Droid Arabic Kufi", serif' : '"Airbnbcereal", sans-serif',
                            width: isSmallScreen && currentLanguage === 'fr'? '23%' :
                            currentLanguage === 'fr'? '12%' :
                             currentLanguage === 'ar' ? '14%' :
                                isSmallScreen ? '25%' :
                                    '14%',
                            right: currentLanguage === 'ar' ? '1%' : 'unset',
