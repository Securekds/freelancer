...
import Supportmenu from '../../Categories/Supportmenu'
...
function SupportComp() {
    ...
    const { gigs, supportGigs, isLoaded, error, selectedSubCategory, setSelectedSubCategory, } = useGig();
