...
function ProfileInfoUpdate({ handleCloseProfileInfo, onAddCardClick1, onCloseClickBilling, logoPath, onCloseClick }) {
    ...
    return (
        ...
        >
            ...
            <Tabs TABS={TABS} handleCloseProfileInfo={handleCloseProfileInfo} onCloseClickBilling={onCloseClickBilling} onCloseClick={onCloseClick} selected={selected} setSelected={setSelected} onAddCardClick1={onAddCardClick1} />
...
const Tabs = ({ handleCloseProfileInfo, onCloseClickBilling, TABS, selected, setSelected, logoPath, onAddCardClick1, onLogoClick, onCloseClick }) => {
    ...
    return (
        ...
        >
            ...
            <AnimatePresence>
                {selected && <Content handleCloseProfileInfo={handleCloseProfileInfo} onCloseClickBilling={onCloseClickBilling} onCloseClick={onCloseClick} logoPath={logoPath} onLogoClick={onLogoClick} dir={dir} selected={selected} TABS={TABS} onAddCardClick1={onAddCardClick1} />}
            </AnimatePresence>
        </div>
    );
};
...
const Content = ({ handleCloseProfileInfo, onCloseClickBilling, selected, dir, TABS, onAddCardClick1, onLogoClick, logoPath, onCloseClick }) => {
                ...
                style={{
                    width: isSmallScreen ? '85vw' :
                        isMediumScreen ? '60vw' :
                            '40vw',
                    padding: "1rem",
                    height: isSmallScreen && currentLanguage === 'ar' ? '600px' :
                        isSmallScreen ? '590px' :
                    ...
                    return (
                        <div style={{}} key={t.id}>
                            {selected === t.id && (
                                ...
                                >
                                    <t.Component handleCloseProfileInfo={handleCloseProfileInfo} onCloseClickBilling={onCloseClickBilling} onCloseClick={onCloseClick} logoPath={logoPath} onLogoClick={onLogoClick} onAddCardClick1={onAddCardClick1} />
...
const Pricing = ({ handleCloseProfileInfo, onCloseBillingUpdate }) => {
    ...
    return (
        ...
        >
            <div className='ClosingIcon'
                onClick={handleCloseProfileInfo}
                style={{
                    position: 'absolute',
            ...
            >
                ...
                >
                    {t("Hello Nabil ! Let's update your profile information.")}
                ...
                >
                    <TextField
                        id="standard-basic"
                        label={t("Qualifications & Expertise")}
                        variant="standard"
                        sx={{
                            '& .MuiInputBase-root': {
                            ...
                            '& .MuiInputLabel-shrink': {
                                color: currentLanguage === 'ar' ? 'white' : 'white',
                                position: currentLanguage === 'ar' ? 'absolute' : 'unset',
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <TextField
                            ...
                            variant="standard"
                            sx={{
                                marginTop: currentLanguage === 'ar' ? '1px' : isLargeScreen ? '-3px' : 'unset',
                                '& .MuiInputBase-root': {
                                    backgroundColor: 'transparent',
                                    width: isSmallScreen && currentLanguage === 'ar' ? '100%' :
                                        isSmallScreen ? '105%' :
                                            '180%',
                                },
                                '& .MuiInputBase-input': {
                                    ...
                                    marginTop: currentLanguage === 'ar' ? '0px' :
                                        isMediumScreen && currentLanguage === 'ar' ? '5px' :
                                            isSmallScreen && currentLanguage === 'ar' ? '0px' :
                                                isMediumScreen ? '-15px' : isSmallScreen ? '-20px' : '-20px',
                                },
                                '& .MuiInputLabel-root': {
                                    position: currentLanguage === 'ar' ? 'absolute' : 'unset',
                                    right: currentLanguage === 'ar' ? '0%' : 'unset',
                        ...
                        <CountrySelect
                            ...
                            sx={{
                                marginLeft: '10px',
                                transform: isSmallScreen ? 'translateY(8px)' : 'none', // Move CountrySelect down on small screens
                                height: isSmallScreen ? '48px' : 'auto', // Adjust height to match input on small screens
                                '& .MuiPaper-root': {
                    ...
                    <div
                        style={{
                            ...
                            marginTop: isSmallScreen && currentLanguage === 'ar' ? '-20px' :
                                currentLanguage === 'ar' ? '-0px' :

                                    isSmallScreen ? '-20px' :

                                        '-10px',
                            gap: isSmallScreen && currentLanguage === 'fr'? '5px' :
                             currentLanguage === 'fr'? '30px' :
                            isSmallScreen ? '5px' :
                             '2 0px',
                        }}
                    >
                        <TextField
                            ...
                            variant="standard"
                            sx={{
                                width: isSmallScreen && currentLanguage === 'ar' ? '260px' :
                                    currentLanguage === 'ar' ? '30%' :
            ...
            <div className="button">
                <Button variant="outlined" className='btn-grad'
                    sx={{
                        ...
                        position: 'absolute',
                        top: isSmallScreen && currentLanguage === 'ar' ? '560px' :
                            isSmallScreen ? '553px' :
