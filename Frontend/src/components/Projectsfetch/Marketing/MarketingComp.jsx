...
import Marketingmenu from '../../Categories/Marketingmenu';
...
function MarketingComp() {
    ...
    const {gigs , marketingGigs, isLoaded, error, selectedSubCategory, setSelectedSubCategory, } = useGig();
  ...
  const totalPages = Math.ceil(marketingGigs.length / gigsPerPage);
  ...
  const currentGigs = marketingGigs.slice(indexOfFirstGig, indexOfLastGig);
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <Button
                        ...
                        sx={{
                            ...
                            justifyContent: 'center',
                            textDecoration: 'none',
                            width: isSmallScreen && currentLanguage === 'ar' ? '20px' :
                                isSmallScreen ? '120px' :
                    ...
                    <div className="CaTegories">
                        ...
                        <div className="Menu"
                            style={{
                                ...
                                top: '22%',
                                right: isSmallScreen ? '6%' : '4%',
                                ...(currentLanguage === 'ar' && {
                                    right: 'unset', // Disable right for Arabic
                                    left: isSmallScreen ? '13%' : '7%',
                ...
                >
                    ...
                    {isLoaded && marketingGigs.length === 0 && (
                        <div
                            style={{
                                width: isSmallScreen ? '100%' : '100%',
                                height: isSmallScreen ? '280px' : '250px',
                    ...
                    {isLoaded && marketingGigs.map((gig) => (
