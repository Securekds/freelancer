...
const Sidenav = () => {
  ...
  useEffect(() => {
    ...
    if (pathname === '/userdashboard') setSelectedButton('Dashboard');
    ...
    else if (pathname.startsWith('/userdashboard/membership')) setSelectedButton('MemberShip');
  }, [location]);
          ...
          <div className='MenuListContainer'
           style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            ...
            >
              ...
              />
              <span style={{ marginRight: currentLanguage === 'ar' ? '8px' : 'unset', fontFamily: currentLanguage === 'ar' ? '"Droid Arabic Kufi", serif' : '"Airbnbcereal", sans-serif', }}>{t('Dashboard')}</span>

            </button>
            <button className='Project'
              style={getMenuButtonStyle(selectedButton === 'Project')}
              onClick={() => handleNavigation('/userdashboard/project', 'Project')}
            >
            ...
            <button className='Billing'
              ...
              onClick={() => handleNavigation('/userdashboard/billing', 'Billing')}
            >
              ...
              <span style={{ marginRight: currentLanguage === 'ar' ? '8px' : 'unset', fontFamily: currentLanguage === 'ar' ? '"Droid Arabic Kufi", serif' : '"Airbnbcereal", sans-serif', }}>{t('Billing')}</span>
            </button>
