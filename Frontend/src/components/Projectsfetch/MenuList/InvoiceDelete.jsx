...
function InvoiceDelete({ onAddCardClick1, onCloseClickBilling, handleCloseInvoice, onCloseClick }) {
    ...
    return (
        ...
        >
            ...
            <Tabs TABS={TABS} handleCloseInvoice={handleCloseInvoice} onCloseClick={onCloseClick} selected={selected} setSelected={setSelected} onAddCardClick1={onAddCardClick1} />
...
const Tabs = ({ handleCloseInvoice, TABS, selected, setSelected, logoPath, onAddCardClick1, onLogoClick, onCloseClick }) => {
    ...
    return (
        ...
        >
            ...
            <AnimatePresence>
                {selected && <Content handleCloseInvoice={handleCloseInvoice} onCloseClick={onCloseClick} logoPath={logoPath} onLogoClick={onLogoClick} dir={dir} selected={selected} TABS={TABS} onAddCardClick1={onAddCardClick1} />}
            </AnimatePresence>
        </div>
    );
};

const Tabe = ({ children, tab, handleSetSelected, selected, handleCloseInvoice }) => {
    return (
        <button
...
const Content = ({ onCloseClickBilling, selected, dir, TABS, onAddCardClick1, handleCloseInvoice, logoPath, onCloseClick }) => {
...
const Pricing = ({ onCloseClickBilling, handleCloseInvoice, onLogoClick, onCloseClick }) => {
