...
function SignupMobile() {
  ...
  const handleCheckboxChange = (event) => {
    ...
    const handleGoogleSignInSuccess = async (response) => {
        ...
        console.log('Extracted User Data:', { givenName, familyName, email, password });
        ...
        try {
            ...
            console.log('User Data Set:', { firstName: givenName, lastName: familyName, email, password });
  ...
  `}
                                ...
                                {inputErrors.firstName && (
                                    <ErrorOutlineIcon
                                        sx={{
                                            ...
                                            fontSize: '20px',
                                            position: 'absolute',
                                            right: currentLanguage === 'ar' ? '38%' : '10px',
                                            top: '50%',
                ...
                {/* Add more components like submit button, etc. */}
            </div>
