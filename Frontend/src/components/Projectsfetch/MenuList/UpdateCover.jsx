...
function UpdateCover({ currentCoverImg, onUpdateCoverImage, handleCloseCover, onAddCardClick1, onCloseClickBilling, setCoverPhoto, onCloseClick }) {
    ...
    return (
        ...
        >
            ...
            <Tabs TABS={TABS} onUpdateCoverImage={onUpdateCoverImage} currentCoverImg={currentCoverImg} handleCloseCover={handleCloseCover} onCloseClickBilling={onCloseClickBilling} onCloseClick={onCloseClick} selected={selected} setSelected={setSelected} onAddCardClick1={onAddCardClick1} />
...
const Tabs = ({ onUpdateCoverImage, currentCoverImg, handleCloseCover, onCloseClickBilling, TABS, selected, setSelected, logoPath, onAddCardClick1, onLogoClick, onCloseClick, setCoverPhoto }) => {
    ...
    return (
        ...
        >
            ...
            <AnimatePresence>
                {selected && <Content currentCoverImg={currentCoverImg} onUpdateCoverImage={onUpdateCoverImage} handleCloseCover={handleCloseCover} onCloseClickBilling={onCloseClickBilling} onCloseClick={onCloseClick} logoPath={logoPath} onLogoClick={onLogoClick} dir={dir} selected={selected} TABS={TABS} onAddCardClick1={onAddCardClick1} />}
            </AnimatePresence>
        </div>
    );
};
...
const Content = ({ currentCoverImg, onUpdateCoverImage, handleCloseCover, onCloseClickBilling, selected, dir, TABS, onAddCardClick1, onLogoClick, logoPath, onCloseClick }) => {
                    ...
                    return (
                        <div style={{}} key={t.id}>
                            {selected === t.id && (
                                ...
                                >
                                    <t.Component onUpdateCoverImage={onUpdateCoverImage} currentCoverImg={currentCoverImg} handleCloseCover={handleCloseCover} onCloseClickBilling={onCloseClickBilling} onCloseClick={onCloseClick} logoPath={logoPath} onLogoClick={onLogoClick} onAddCardClick1={onAddCardClick1} />
...
const Pricing = ({ handleCloseCover, onUpdateCoverImage, currentCoverImg }) => {
    ...
    const { user, updateUserCoverImage } = useUser(); // Access user data from UserContext
    ...
    const uploadImageToBackend = async (file) => {
        ...
        console.log('Uploading image to backend for user:', user._id);
        ...
        try {
            const response = await axios.put(
                `${import.meta.env.VITE_BACKEND_URL}/server/users/${user._id}/cover`,
                formData,
                {
            ...
            // Update only the cover image in the user context
            const { user: updatedUser } = response.data;
            console.log('Response from backend:', response.data);
            updateUserCoverImage(updatedUser.coverImg);

            // Update the image preview
            setUploadedImageUrl(updatedUser.coverImg);
                ...
                <>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                {t('Cover Photo Updated Successfully')}
                            </Typography>
                            <Typography
                                sx={{
                                    fontFamily: currentLanguage === 'ar' ? '"Droid Arabic Kufi", serif' : '"Airbnbcereal", sans-serif',
                            ...
                            >
                                {t('Your new cover photo has been saved successfully.')}
                            </Typography>
                        </div>
