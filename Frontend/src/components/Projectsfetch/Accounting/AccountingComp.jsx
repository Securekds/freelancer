...
import Accountingmenu from '../../Categories/Accountingmenu'
...
function AccountingComp() {
    ...
    const { gigs, accountingGigs, isLoaded, error, selectedSubCategory, setSelectedSubCategory, } = useGig();
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <Button
                        ...
                        sx={{
                            ...
                            border: 'none',
                            height: '50px',
                            marginRight: isSmallScreen && currentLanguage === 'ar' ? '-25px' :
                                currentLanguage === 'ar' ? '-17px'
                                    : 'unset',
                            borderRadius: '25px',
                ...
                >
                    ...
                    {isLoaded && accountingGigs.length === 0 && (
                        <div
                            style={{
                                width: isSmallScreen ? '100%' : '100%',
                                height: isSmallScreen ? '280px' : '250px',
                    ...
                    {isLoaded && accountingGigs.map((gig) => (
