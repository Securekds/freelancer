...
import ResponsiveAll from './ResponsiveAll';
...
function ProjectMobile({handleOpenUserVerify}) {
    ...
    return (
        <>
            ...
            <div className='PeojectMobileContainer'
                style={{
                    display: 'flex',
                                ...
                                >
                                    <Button
                                        style={{
                                            ...
                                            padding: '0.5rem 1rem',
                                            color: '#f9fafb',
                                            transition: 'transform 0.3s ease, background-color 0.2s', // Added transform transition
                                            '&:hover': {
