...
function BillingInfoDelete({ onAddCardClick1, onCloseClickBilling, InfoClose, onCloseClick }) {
    ...
    return (
        ...
        >
            ...
            <Tabs TABS={TABS} InfoClose={InfoClose} onCloseClickBilling={onCloseClickBilling} onCloseClick={onCloseClick} selected={selected} setSelected={setSelected} onAddCardClick1={onAddCardClick1} />
...
const Content = ({ onCloseClickBilling, selected, dir, TABS, onAddCardClick1, onLogoClick, InfoClose, onCloseClick }) => {
                    ...
                    return (
                        <div style={{}} key={t.id}>
                            {selected === t.id && (
                                ...
                                >
                                    <t.Component onCloseClickBilling={onCloseClickBilling} onCloseClick={onCloseClick} InfoClose={InfoClose} onLogoClick={onLogoClick} onAddCardClick1={onAddCardClick1} />
...
const Pricing = ({ onCloseClickBilling, InfoClose, onLogoClick, onCloseClick }) => {
...
export default BillingInfoDelete
